...
<html lang="pt-BR">
<head>
	<title>SGE - Sistema de Gestão de Estoque - Produtos</title>
...
<script type="text/javascript">
	...
	function eliminarProduto(idProduto){
		alertify.confirm('IMPORTANTE!', 'Deseja excluir este produto?', function(){ 
			$.ajax({
				type:"POST",
				...
				success:function(r){
					if(r==1){
						...
						alertify.error("Produto não excluido!");
					}
				}
			});
		}, function(){ 
			...
			$.ajax({
				...
				success:function(r){
					...
					if(r == 1){
						...
						alertify.error("Falha ao adicionar novo produto!");
					}
				}
			});
